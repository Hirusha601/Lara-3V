...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "SFAAUAAY#Ke5uo-wtGZEMC3JKWi0jllKSuABlkeGdaY9uYA2fiWs", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94725663281",
DEV: process.env.DEV || "94725663281",
